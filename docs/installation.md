...
rebuilt. If automation or testing must be done against nighlies or you cannot
...
```bash
pip install jaxlib==0.3.25+cuda11.cudnn82 -i https://us-python.pkg.dev/ml-oss-artifacts-published/jax/simple/
```
